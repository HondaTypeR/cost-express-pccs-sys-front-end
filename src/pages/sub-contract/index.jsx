...
import { subDeleteContract, subListContract } from "@/services/contract.js";
...
const Contract = () => {
  ...
  const columns = [
    {
      title: "原合同ID",
      dataIndex: "own_contract_id",
      width: 100,
      hideInSearch: true,
    },
    {
      title: "ID",
      dataIndex: "sub_contract_id",
      width: 100,
    },
    {
      title: "合同类型",
    ...
    },
    {
      ...
      render: (text, record) => [
        ...
        <RelatedContentModal
          key="related"
          contractId={record.sub_contract_id}
          trigger={<a>关联内容</a>}
        />,
        <Popconfirm
          title="确认删除"
          ...
          onConfirm={async () => {
            const res = await subDeleteContract({
    ...
    <PageContainer>
      <ProTable
        ...
        request={async (params, sort, filter) => {
          ...
          const res = await subListContract(requestParams);
          return {
            data: res.data || [],
