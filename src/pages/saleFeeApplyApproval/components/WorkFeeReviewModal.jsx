...
const WorkFeeReviewModal = (props) => {
  const { trigger, onOk, users, record } = props;
    ...
    >
      ...
      {approvalStatus !== 2 && (
        <ProFormSelect
          ...
          placeholder="请选择审核人"
          initialValue={
            record?.current_apply_level && LEVEL_MAP[record.current_apply_level]
              ? Number(record[LEVEL_MAP[record.current_apply_level]]) ||
                undefined
              : undefined
          }
          options={users}
...
export default WorkFeeReviewModal;
