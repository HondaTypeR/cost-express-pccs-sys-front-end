    ...
    <PageContainer>
      <ProTable
        ...
        request={async (params, sort, filter) => {
          const res = await listArtificial({
            params: {
              ...params,
              page: params.current,
          ...
          return (
            <>
              <ProTable.Summary.Row>
                {/* 合并从 序号 到 单位 共8列，使数值正好对齐在 数量 及其后面 */}
                ...
                {/* 关联合同-操作 等剩余 6 列 */}
                <ProTable.Summary.Cell index={13} colSpan={6} />
              </ProTable.Summary.Row>
            </>
          );
        }}
